  ...
  return (
    <main className="relative w-full min-h-[115vh] overflow-x-hidden flex flex-col items-center font-sans selection:bg-white/20 selection:text-white">
      ...
      <div className="relative z-10 w-full max-w-7xl px-4 md:px-8 flex flex-col flex-1">
        ...
        >
          <p className="text-[11px] uppercase tracking-widest text-white/50 mb-6 font-medium">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-xl leading-relaxed mb-10">
            ...
            &mdash; curated and shared with the world, always free.
          </p>
          <a
            href="#"
            className="inline-flex items-center gap-2 px-8 py-3 rounded-full text-white text-sm font-medium liquid-glass hover:bg-white/10 transition-colors"
          >
            Explore Now
          </a>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-12 mb-10">
            ...
            <div className="md:col-span-5">
              ...
              <p className="text-sm leading-relaxed max-w-sm">
                ...
                wonders &mdash; shared with all for free.
              </p>
            </div>
